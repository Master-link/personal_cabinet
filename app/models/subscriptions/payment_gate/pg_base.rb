...
#
# Платежи банковскими картами в ТМ
class ::Subscriptions::PaymentGate::PgBase < ::Subscriptions::SubscriptionBase
  include PaymentSystems

  # разрешено активировать множество подписок
  def on_activate
    activated! if may_activated?
    Success()
  end

  # приостановить/восстановить(ативировано) без условий схоже смс и ГР, т.к. может быть несколько подписок
  def shift_suspend!
